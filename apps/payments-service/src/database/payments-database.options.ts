...
export const paymentsEntities = [PaymentOutboxMessage, PaymentProcessedMessage];
export const paymentsMigrations = [CreatePaymentsMessagingInfrastructure1725001000000];
